...
public class ApiProductController {
    ...
    @DeleteMapping("/products/{cakeId}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @CrossOrigin
    public void delete(@PathVariable(value = "cakeId") int id) {
    ...
    @RequestMapping(path = "/products/{cakeId}/", produces = MediaType.APPLICATION_JSON_VALUE)
    @CrossOrigin
    public ResponseEntity<Product> details(@PathVariable(value = "cakeId") int id) {
    ...
    @GetMapping("/products/{cakeId}/comments/")
    @CrossOrigin
    public ResponseEntity<List<Comment>> listComments(@PathVariable(value = "cakeId") int id) {
        return new ResponseEntity<>(this.commentService.getComments(id,1), HttpStatus.OK);
    }
